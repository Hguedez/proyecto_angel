...
<form action="/tipos/{{$id_tipo_cerveza}}/ofertas/{{$id_oferta}}/ofertasCerveza/{{$correo}}/funciona" method="POST">
        @csrf
      ...
      <input type="text" name="precio_venta" placeholder="Precio" class="form-control mb-2"required>
       ...
       <a href="/tipos/1/ofers/{{$correo}}/funciona" class="btn btn-primary btn-sm">Volver al menu anterior</a>
    </form>
</div>
