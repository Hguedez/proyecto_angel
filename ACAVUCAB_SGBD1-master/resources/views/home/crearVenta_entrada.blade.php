...
<form action="/entradas/{{$id_entrada}}/ventaEntrada/{{$precio_entrada}}/montoTotal/{{$correo}}/funciona" method="POST">
        @csrf
...
<a href="/entradas/{{$id_entrada}}/ventaEntrada/{{$precio_entrada}}/montoTotal/{{$correo}}/funciona" class="btn btn-primary btn-sm">Volver al menu anterior</a>
    </form>
</div>
