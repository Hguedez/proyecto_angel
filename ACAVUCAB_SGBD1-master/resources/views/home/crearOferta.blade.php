...
<div id="contact">
  ...
  <div class="container">
      ...
      <div class="col-md-6 centrado">
        <form action="/tipos/{{$id_tipo_cerveza}}/ofers/{{$correo}}/funciona" method="POST">
          @csrf
          ...
          <div class="form-group">
            ...
            <a href="/tipos/{{$id_tipo_cerveza}}/ofers/{{$correo}}/funciona" class="btn btn-primary btn-sm sizee">Volver al menu anterior</a>
